...
{
	int xPos = xPosition / Block::TILE_SIZE;
	int yPos = yPosition / Block::TILE_SIZE;

	int xNewPos = (xPosition + x) / Block::TILE_SIZE;
	int yNewPos = (yPosition + y + Block::TILE_SIZE / 2) / Block::TILE_SIZE;
